...
class MassUploader(tk.Tk):
    ...
    def render_mass_uploader(self):
        ...
        manga_ids = tk.Text(self.frame, height=3, width=40)
        manga_ids.grid(row=0, column=1)
        volumes = tk.Text(self.frame, height=5, width=40)
        volumes.grid(row=1, column=1)
        chapters = tk.Text(self.frame, height=5, width=40)
        chapters.grid(row=2, column=1)
        titles = tk.Text(self.frame, height=5, width=40)
        titles.grid(row=3, column=1)
        languages = tk.Text(self.frame, height=3, width=40)
        languages.grid(row=4, column=1)
        group_1_ids = tk.Text(self.frame, height=3, width=40)
        group_1_ids.grid(row=5, column=1)
        group_2_ids = tk.Text(self.frame, height=3, width=40)
        group_2_ids.grid(row=6, column=1)
        group_3_ids = tk.Text(self.frame, height=3, width=40)
        group_3_ids.grid(row=7, column=1)
        group_4_ids = tk.Text(self.frame, height=3, width=40)
        group_4_ids.grid(row=8, column=1)
        group_5_ids = tk.Text(self.frame, height=3, width=40)
